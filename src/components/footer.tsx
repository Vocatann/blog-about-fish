  ...
  return (
    <footer className="border-t-2 border-border flex flex-col justify-center space-y-5 py-10">
      <ul className="flex space-x-2 justify-center">
        ...
        <li><a href="https://github.com/Vocatann" target="_blank" className="text-accent hover:underline">Github</a></li>
        <li><a href="https://x.com/home" target="_blank" className="text-accent hover:underline">Twitter</a></li>
      </ul>
